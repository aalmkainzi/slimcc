...
echo '_Nameprefix A = "A_"; constexpr int i = 1; constexpr int j = 3; _Apply _Nameprefix A { constexpr int i = 2; _Static_assert(i == 2); _Static_assert(_Global::A_i == 2); _Static_assert(_Global::A::i == 2); _Static_assert(_Global::j == 3); }' | $testcc -std=c23 -o- -S -xc -
check nameprefix
...
echo '_Nameprefix AA = "AA_"; _Nameprefix aa = AA; _Apply _Nameprefix AA { constexpr int foo = 10; } _Static_assert(AA_foo == AA::foo); _Static_assert(AA::foo == aa::foo); int main() { _Nameprefix a = aa; _Static_assert(aa::foo == a::foo); }' | $testcc -std=c23 -o- -S -xc -
check nameprefix
